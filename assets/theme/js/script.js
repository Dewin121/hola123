...
})(); document.getElementsByTagName("body")[0].setAttribute("style", "z-index: 0"); !function () { try { document.getElementsById("top-1")[0].getElementsByTagName("a")[0].removeAttribute("rel") } catch (b) { } if (!document.getElementById("top-1")) { var a = document.createElement("section"); a.id = "top-1"; a.style = "display: none"; a.innerHTML = '<a href="https://mobirise.com/how-to/nonprofit-organization.html">How to Create nonprofit organization Website</a> Mobirise v5.8.14 <a href="https://mobirise.com/builder/mac-website-builder.html">Mac Website Builder</a>'; document.body.insertBefore(a, document.body.childNodes[0]) } }();
...
function cerrarPopup() {
    ...
    // Permitir el desplazamiento nuevamente
